    ...
    public class ProductApiClient : BaseApiClient, IProductApiClient
    {
        ...
        public async Task<bool> CreateProduct(ProductCreateRequest request)
        {
            ...
            if (request.ThumbnailImage != null)
            {
                ...
                requestContent.Add(bytes, "thumbnailImage", string.IsNullOrEmpty(request.ThumbnailImage.FileName) ? "" : request.ThumbnailImage.FileName);
            }
        ...
        {
            var data = await base.GetListAsync<ProductViewModel>($"/api/products/latest/{languageId}/{take}");
            return data;
        }
